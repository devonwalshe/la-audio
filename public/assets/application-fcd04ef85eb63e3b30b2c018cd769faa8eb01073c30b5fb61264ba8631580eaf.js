...
$( window ).load(function() {
  ...
  function insertTotalTime(){
    ...
    var minutes = Math.floor(interviewLength / 60);
    var seconds = Math.round(interviewLength % 60);
...
function stepBackInterview(){
  var interview = document.getElementById("audioPlayer");
  currentTime = interview.currentTime;
  interview.currentTime = 50;
};
  
function stepForwardInterview(){
  var interview = document.getElementById("audioPlayer");
  currentTime = interview.currentTime;
  interview.currentTime = 30;
};
